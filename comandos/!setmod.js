...
exports.run = (bot, message, args) => {
  ...
  .setDescription('<:incorreto:737091863558750279> **|** Apenas membros da equipe superior podem usar esse comando!')

  if(!['389866221295763456', '449240801520779266'].includes(message.author.id)) return message.channel.send(a1)

  let a2 = new Discord.MessageEmbed()
  .setDescription('<:incorreto:737091863558750279> **|** Você precisa me informar o tipo!')

  let a3 = new Discord.MessageEmbed()
  .setDescription('<:incorreto:737091863558750279> **|** Você precisa me informar o usuário!')
  ...
  if(tipo.toLowerCase() == 'image') {
    ...
    .setDescription('<:incorreto:737091863558750279> **|** Você precisa me informar a URL!')

    let valor1 = args[2]
    if(!valor1) return message.channel.send(a4)

    let a5 = new Discord.MessageEmbed()
    .setDescription(`<:correto:737091697615568957> **|** A imagem do usuário ${membro} foi setada para **${valor1}** com sucesso!`)
    ...
    .setDescription('<:incorreto:737091863558750279> **|** Você precisa me informar a cor!')

    let valor2 = args.slice(2).join(' ').toUpperCase();
    if(!valor2) return message.channel.send(a6)

    let a7 = new Discord.MessageEmbed()
    .setDescription(`<:correto:737091697615568957> **|** A cor do usuário ${membro} foi setada para **${valor2}** com sucesso!`)
    ...
    .setDescription('<:incorreto:737091863558750279> **|** Você precisa me informar a descrição!')

    let valor3 = args.slice(2).join(' ')
    if(!valor3) return message.channel.send(a8)

    let a9 = new Discord.MessageEmbed()
    .setDescription(`<:incorreto:737091863558750279> **|** A descrição do usuário ${membro} foi setada para **${valor3}** com sucesso!`)
    ...
    .setDescription('<:incorreto:737091863558750279> **|** O tipo precisa ser image, color ou desc!')
